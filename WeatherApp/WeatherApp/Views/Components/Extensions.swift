...
extension Color {
    ...
    static let customTabBarBorder = Color("Tab Bar Border").opacity(0.5)
    static let customForecastCardBackground = Color("Forecast Card Background")
    static let customProbabilityText = Color("Probability Text")
}
